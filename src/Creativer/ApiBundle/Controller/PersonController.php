 ...
 */
    ...
    public function searchPeopleAction()
    {
        ...
        if($search_people == 'undefined'){
            ...
            $keywordQuery->setQuery("username:".$search_people." OR lastname:".$search_people." OR info:".$search_people." OR specialization:".$search_people);
        }
    ...
    {
        $id = $this->get('request')->request->get('id');
        $post = $this->getDoctrine()->getRepository('CreativerFrontBundle:Posts')->findOneById($id);
