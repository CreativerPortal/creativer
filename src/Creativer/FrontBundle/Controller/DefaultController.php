...
class DefaultController extends Controller
{
    ...
    public function fleamarketpostingTmpAction($date){
    ...
    public function searchProductsTmpAction(){
    ...
    public function showSearchProductPhotoTmpAction(){


        return $this->render('CreativerFrontBundle:Default:show_search_product_photoTmp.html.twig');
    }
    ...
    public function legalInformationAction(){
        return $this->render('CreativerFrontBundle:Default:legal_information.html.twig', array());
    }
