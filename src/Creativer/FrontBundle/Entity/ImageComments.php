...
class ImageComments
{
     ...
     * @JMS\Groups({"getAlbumComments", "getCatalogProductAlbums", "searchProducts"})
     * @JMS\Expose
     */
    private $id;
     ...
     * @JMS\Groups({"getAlbumComments", "getAlbumById", "getCatalogProductAlbums", "searchProducts"})
     **/
    private $user;
     ...
     * @JMS\Groups({"getAlbumComments", "getCatalogProductAlbums", "searchProducts", "getCatalogProductAlbums"})
     */
    private $text;
